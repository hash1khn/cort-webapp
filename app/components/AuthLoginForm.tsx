...
interface AuthLoginFormProps {
    ...
    allowRoleRedirect?: boolean; // if true, redirects based on role to proper dashboard. if false, might stay or custom.
    defaultRedirectPath?: string;
    logoSrc?: string;
    backgroundImageColor?: string; // e.g. "bg-blue-600/20"
}
...
export default function AuthLoginForm({
    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden bg-[#0f172a] font-sans selection:bg-[#f47f00]/30">
            {/* Background Effects - Generic or customizable via props if needed, keeping simple for now */}
